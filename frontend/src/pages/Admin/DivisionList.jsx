    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {loading ? (
          ...
          <div key={d.id} className="bg-white rounded-3xl border border-slate-200 shadow-sm p-6 hover:shadow-md transition-shadow relative group">
            ...
            <span className="inline-block mt-1 text-xs font-bold text-indigo-500 bg-indigo-50 px-2 py-0.5 rounded-md">{d.acronyme}</span>
