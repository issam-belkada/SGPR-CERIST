...
export default function Sidebar({ title, links }) {
  ...
  return (
    <div className="w-72 h-screen bg-slate-950 text-white flex flex-col shrink-0 p-4 border-r border-slate-900 shadow-2xl overflow-hidden">
      
      {/* HEADER : Fixe en haut */}
      <div className="px-4 py-8 mb-2 shrink-0">
      ...
      {/* - overflow-y-auto : active le scroll vertical
          - pr-2 : ajoute un petit espace pour que la scrollbar ne colle pas aux liens
          - scrollbar-thin : (si vous utilisez le plugin tailwind-scrollbar)
      */}
      <nav className="flex-1 overflow-y-auto space-y-1.5 px-2 custom-scrollbar">
      ...
      <div className="mt-auto pt-4 shrink-0">
        <div className="p-4 bg-slate-900/40 rounded-2xl border border-white/5 mx-2 mb-2">
      ...
      {/* STYLE CSS POUR LA SCROLLBAR (À mettre dans votre index.css) */}
